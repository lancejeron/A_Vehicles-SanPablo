...
router.post('/edit', (req, res) => {
    var db = require('../../lib/database')();
    db.query(`INSERT INTO \`users\` (\`id\`, \`make\`, \`model\`, \`year\`, \`plate_number\`, \`vcondition\`)  VALUES (${req.body.make}, "${req.body.make}", "${req.body.model}", "${req.body.year}", "${req.body.plate_number}", "${req.body.vcondition}")`, (err, results, fields) => {
